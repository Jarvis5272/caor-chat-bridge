...
- 当前结果是 metadata-only 同步快照，latest result 为 `results/dfapc_distilled_fast_anchor_posterior_validation_20260706`。
- latest final label 是 `DFAPC_FAIL_DISTILLATION_NO_GENERALIZATION`。
