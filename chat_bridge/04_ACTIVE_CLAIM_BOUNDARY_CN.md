...
- 当前结果是 metadata-only 同步快照，latest result 为 `results/edit_event_identity_certificate_synthesis_20260704`。
- latest final label 是 `IDENTITY_CERTIFICATE_READY_FOR_HAND_TOY`。
