...
- 当前结果是 metadata-only 同步快照，latest result 为 `results/quality_speed_pareto_long_goal_cleanids_20260706`。
- latest final label 是 `PARETO_STOP_GROUP_ROBUSTNESS_BARRIER`。
