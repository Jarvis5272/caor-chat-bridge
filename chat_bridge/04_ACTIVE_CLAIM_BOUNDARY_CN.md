...
- 当前 claim boundary 是：可以说：IPDP/OCMC/SDEC 已按 latest checkpoint 继续验证，并且没有重复消费 EPMC/DRNC/CPMC/LEMSC/NODC/RSPC。可以报告 absolute quality/speed/group/safety 和 failure reason。
