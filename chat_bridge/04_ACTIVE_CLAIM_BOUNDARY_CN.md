...
- 当前结果是 metadata-only 同步快照，latest result 为 `results/v1_exact_parallel_deployment_20260708`。
- latest final label 是 `FINAL_EXACT_PARALLEL_DEPLOYMENT_RELAXED_SUCCESS`。
