...
- 当前 claim boundary 是：可以说：EPMC/DRNC/CPMC 已按 checkpoint 恢复并验证；它们比上一轮更严格，禁止使用 CGBAPC/BAPC teacher output online。可以报告 absolute quality/speed/group/safety 和 failure reason。
