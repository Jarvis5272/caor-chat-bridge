...
1. final label: `CHEAP_FEATURE_NO_GENERALIZING_SEPARABILITY`
2. output dir: `results/full_scope_cheap_feature_separability_rebuild_20260706`
...
4. key metrics:
- missing
5. gate decision: PASS: prior failure and required inputs are available; proceed to larger feature generation.
