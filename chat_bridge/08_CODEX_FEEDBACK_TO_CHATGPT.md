...
6. claim boundary: BAEPC toy-only prototype passed on declared toy cases; not real-data proven, not smoke, not benchmark, and not decoder success on CleanIDS.
7. next recommendation: Real-data synchronization dry-run is allowed next with explicit user approval; no smoke, benchmark, or algorithm success claim.
