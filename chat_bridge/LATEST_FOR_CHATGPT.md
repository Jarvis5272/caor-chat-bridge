...
- Latest task event: `OLIGO0_FULL_RESULT_LOCKED_BRIDGE_AUTH_REQUIRED` at `results/full_source_oligo0_actual_20260711`.
...
- Codex: review and paper-sync the locked oligo0 full-source result; do not start medium or large without an explicit task.
