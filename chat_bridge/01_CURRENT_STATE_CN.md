...
最新结果目录 `results/mgcs_mini_global_consensus_search_20260708` 是当前 latest result；最新 label 是 `MGCS_ORACLE_POTENTIAL_RERANKER_FAILURE`。
...
当前 active track: `missing`。根据 latest gate，当前结论是 `MGCS_ORACLE_POTENTIAL_RERANKER_FAILURE`。
...
MGCS_ORACLE_POTENTIAL_RERANKER_FAILURE
