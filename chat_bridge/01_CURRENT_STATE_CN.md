...
最新结果目录 `results/cecc_cross_event_consensus_certificate_20260707` 是当前 latest result；最新 label 是 `CECC_TASK_INITIALIZED`。
...
当前 active track: `missing`。根据 latest gate，当前结论是 `CECC_TASK_INITIALIZED`。
