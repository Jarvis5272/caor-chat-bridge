...
1. final label: `FINAL_COMPILED_ACCELERATION_BLOCKED`
2. output dir: `results/v1_compiled_engineering_acceleration_20260709`
3. completed stages: missing
4. key metrics:
- missing
5. gate decision: FINAL_COMPILED_ACCELERATION_BLOCKED
