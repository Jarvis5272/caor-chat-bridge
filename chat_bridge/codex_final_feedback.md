...
1. final label: `PAPER_RESTART_VALIDATION_AND_SCALE_PLAN_READY`
2. output dir: `results/paper_restart_and_validation_20260710`
3. completed stages: missing
4. key metrics:
- missing
5. gate decision: PAPER_RESTART_VALIDATION_AND_SCALE_PLAN_READY
