...
1. final label: `FPCR_NO_ACCEPTABLE_IMPROVEMENT`
2. output dir: `results/fpcr_fast_path_consistency_reconstruction_20260708`
3. completed stages: missing
4. key metrics:
- missing
5. gate decision: FPCR_NO_ACCEPTABLE_IMPROVEMENT
