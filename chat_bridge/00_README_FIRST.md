...
服务器显式结果为 `results/paper_restart_and_validation_20260710`；当前最新 Codex label 为 `PAPER_RESTART_VALIDATION_AND_SCALE_PLAN_READY`。当前 bridge 初始化状态为 `CHAT_BRIDGE_WORKFLOW_INITIALIZED`。
