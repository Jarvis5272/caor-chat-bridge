...
服务器显式结果为 `results/current_project_source_refresh_20260710`；当前最新 Codex label 为 `CURRENT_PROJECT_SOURCE_REFRESH_AND_UPLOAD_PACKAGE_READY`。当前 bridge 初始化状态为 `CHAT_BRIDGE_WORKFLOW_INITIALIZED_WITH_MISSING_CONTEXT`。
...
`results/current_project_source_refresh_20260710`
